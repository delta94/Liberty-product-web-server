...
import { UserJobResolver } from './src/modules/userJobs/UserJobResolver';
// import { filter } from 'lodash';
// import { ProductData } from './entity/ProductData';
import * as dotenv from 'dotenv';
import { UserJob } from './src/entity/UserJob';
import { zipFilesByDirectory, isDirectoryAsync, deleteFilesInFolder, getFileSizeInMegabytes } from './src/utils/fileOperations';
import * as moment from 'moment';
import * as fs from 'fs';
import * as nodemailer from 'nodemailer';
import { main, row, bottom } from './src/mail/downloads';
