...
@ObjectType()
@Entity({ name: 'Open_Order_Data_OVER03', database: 'LFI', synchronize: false })
export class OpenOrderDataView extends BaseEntity {
  @Field({ nullable: true, name: 'SOPTYPE' })
  @Column({ name: 'SOPTYPE' })
  public SopType: number;

  @Field({ nullable: true, name: 'SOPNUMBE' })
  ...
  @Field({ nullable: true, name: 'ADD_PO' })
  @Column({ name: 'ADD_PO#' })
  ...
  @Field({ nullable: true, name: 'LOCNCODE' })
  @Column({ name: 'LOCNCODE' })
  public LocationCode: string;

  @Field({ nullable: true, name: 'Order_LOCNCODE' })
  ...
  @Field({ nullable: true, name: 'Service_Level_Code' })
  @Column({ name: 'Service_Level_Code' })
  public Service_Level_Code: string;
