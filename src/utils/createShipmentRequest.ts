import { checkNumber, throwNull2NonNull, throwNotObject, throwIsArray, checkArray, checkString, checkBoolean } from './xpoUtils';
...
let obj: any = null;
export class CreateShipmentRequestProxy {
  public readonly request_header: RequestHeaderProxy;
  public readonly bookings: BookingsEntityProxy[] | null;
  public static Parse(d: string): CreateShipmentRequestProxy {
    return CreateShipmentRequestProxy.Create(JSON.parse(d));
  }
  public static Create(d: CreateShipmentRequest, field: string = 'root'): CreateShipmentRequestProxy {
    if (!field) {
      obj = d;
      field = 'root';
    }
    ...
    return new CreateShipmentRequestProxy(d);
  }
...
export class OrganizationProxy {
  ...
  public static Create(d: Organization, field: string = 'root'): OrganizationProxy {
    if (!field) {
      obj = d;
      field = 'root';
    }
...
export class OptionsEntityProxy {
  ...
  public static Create(d: OptionsEntity, field: string = 'root'): OptionsEntityProxy {
    if (!field) {
      obj = d;
      field = 'root';
    }
...
export class AttributesEntityProxy {
  ...
  public static Create(d: AttributesEntity, field: string = 'root'): AttributesEntityProxy {
    if (!field) {
      obj = d;
      field = 'root';
    }
...
export class LocationsEntityProxy {
  ...
  public static Create(d: LocationsEntity, field: string = 'root'): LocationsEntityProxy {
    if (!field) {
      obj = d;
      field = 'root';
    }
...
export class AddressProxy {
  ...
  public static Create(d: Address, field: string = 'root'): AddressProxy | null {
    if (!field) {
      obj = d;
      field = 'root';
    }
...
export class ContactProxy {
  ...
  public static Create(d: Contact, field: string = 'root'): ContactProxy | null {
    if (!field) {
      obj = d;
      field = 'root';
    }
...
export class ContainersEntityProxy {
  ...
  public static Create(d: ContainersEntity, field: string = 'root'): ContainersEntityProxy {
    if (!field) {
      obj = d;
      field = 'root';
    }
...
export class MeasurementsProxy {
  ...
  public static Create(d: Measurements, field: string = 'root'): MeasurementsProxy {
    if (!field) {
      obj = d;
      field = 'root';
    }
